defmodule Hiverec.Handler.Preferences do
  ...
  def gen_data(conn) do
    ...
    insparamtype_list_items =
      ...
      %Data.PreferencesPage.InsparamtypeListItem{
        ...
        get_insparamtype_update_data_url: Routes.page_url(conn, :get_insparamtype_update_data, insparamtype),
  ...
  defp gen_update_data(conn, insparamtype, errors \\ %{}) do
    ...
    locale = Common.locale(conn)
    %Data{data_url: Routes.page_url(conn, :get_insparamtype_update_data, insparamtype),
          locale: locale,
          ...
          translations: translate_domains(["menu", "preferences", "insparamtype", "form"], locale)
    }
  end
