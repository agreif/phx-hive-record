defmodule Hiverec.Handler.Location do
      ...
      |> Enum.map(fn location ->
        ...
        %Data.LocationListPage.LocationListItem{
          ...
          get_location_detail_data_url:
            Routes.page_url(conn, :get_location_detail_data, location),
  ...
  def process_post_add(conn, params) do
    ...
    case result do
      {:ok, _} ->
        Handler.Location.gen_list_data(conn)
  ...
  def gen_add_data(conn, params \\ %{}, errors \\ %{}) do
    ...
    %Data{
      data_url: Routes.page_url(conn, :get_location_add_data),
      locale: locale,
      navbar: Common.gen_navbar(conn, :location_list),
      history_state: nil,
      preferences_url: Routes.page_url(conn, :get_preferences_page),
      ...
      pages: %Data.Pages{
        location_detail: %Data.LocationDetailPage{
          ...
          get_location_update_data_url:
            Routes.page_url(conn, :get_location_update_data, location),
  ...
  defp gen_update_data(conn, location, errors \\ %{}) do
    ...
    %Data{
      data_url: Routes.page_url(conn, :get_location_update_data, location),
      locale: locale,
      navbar: Common.gen_navbar(conn, :location_list),
      history_state: nil,
      preferences_url: Routes.page_url(conn, :get_preferences_page),
